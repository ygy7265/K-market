			...
			<table>
				...
				<tr>
					...
					<td><input type="text" name="km_uid" placeholder="아이디를 입력"
						required /> <span class="msgId">&nbsp;&nbsp;영문, 숫자로
							4~12자까지 설정해 주세요.</span></td>
				</tr>
				<tr>
					<th><span class="essential">*</span>비밀번호</th>
					<td><input type="password" name="km_pass1"
						placeholder="비밀번호를 입력" required /> <span class="msgPass1">&nbsp;&nbsp;영문,
		...
		<section>
			<table>
				...
				<tr>
					...
					<td><input type="text" name="km_name" placeholder="대표자 입력" required />
				...
				<tr>
					...
					<td><input type="text" name="km_hp" placeholder="전화번호 입력"
						required /> <span class="msgHp">&nbsp;&nbsp;- 표시 포함,
				...
				<tr>
					...
					<td><input type="email" name="kms_email" placeholder="이메일 입력" required />
					...
					<td>
						<div>
							<input type="text" name="km_zip" id="zip"
								placeholder="우편번호 입력 클릭" readonly onclick="zipcode()" />
						</div>
						<div>
		...
		<section>
			<table>
				...
				<tr>
					...
					<td><input type="text" name="kms_manager" placeholder="이름을 입력" required />
					<span class="msgManager"></span></td>
				</tr>
				<tr>
					<th><span class="essential">*</span>휴대폰</th>
					<td><input type="text" name="kms_managerHp" maxlength="13"
						placeholder="휴대폰번호 입력" required /> <span class="msgManagerHp">&nbsp;&nbsp;-
